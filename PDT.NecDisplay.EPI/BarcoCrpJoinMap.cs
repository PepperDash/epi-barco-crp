...
namespace PDT.BarcoCrp.EPI
{
	...
	/// </example>
	public class BarcoCrpJoinMap : JoinMapBaseAdvanced
	{
		#region Digital
		...
		[JoinName("LoadPerspective")]
		public JoinDataComplete LoadPerspective = new JoinDataComplete(
			new JoinData
			{
				JoinNumber = 2,
				JoinSpan = 1
			...
			new JoinMetadata
			{
				Description = "LoadPerspective",
				JoinCapabilities = eJoinCapabilities.ToFromSIMPL,
				JoinType = eJoinType.Serial
			});
		[JoinName("LoadSource")]
		public JoinDataComplete LoadSource = new JoinDataComplete(
			new JoinData
			{
				JoinNumber = 10,
				JoinSpan = 10
		...
		public BarcoCrpJoinMap(uint joinStart)
			: base(joinStart, typeof(BarcoCrpJoinMap))
		{
		}
	}
}
